...
//         <img src={assets.logo_11} alt="" width={150}/>
//         <p className='flex-1 border-l pl-4 border-gray-400 text-sm text-gray-500 max-sm:hidden'>copyright @kamalkumar.com | All rights reserved</p>
