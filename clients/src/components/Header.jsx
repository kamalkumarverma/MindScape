...
//         className='inline-flex text-stone-500 text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>
...
//         className='flex items-center gap-2 bg-black text-white rounded-full sm:text-lg w-auto mt-8 px-12 py-2.5'>
//             Generate Images
